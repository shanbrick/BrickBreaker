...
public class GameLoop {
    ...
    public void setup() {
        ...
        // create collision handler instance to use throughout program for detecting
        // collisions such as the ball hitting the paddle or the ball hitting a brick
    ...
    public void update() {
        ...
        // if when paddle is moved, it runs into the ball, it pushes the ball over a
        // little bit
        ...
        // check if ball hit ceiling -- if so, reverse its direction so it starts to
        // move downwards
        ...
        // check if ball has collided with any of the bricks after it has moved up or
        // down
        ...
        // check if ball hit either the left or right walls -- if so, reverse its
        // direction
        ...
        // check if ball has collided with any of the bricks after it has moved left or
        // right
    ...
    // GamePanel file uses this to tell GameLoop which direction was pressed (left
    // or right)
